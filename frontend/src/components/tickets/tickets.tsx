      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Ritu" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
            <Label htmlFor="lastname">Last name</Label>
            <Input id="lastname" placeholder="Raj" type="text" />
          </LabelInputContainer>
        </div>
        ...
        <LabelInputContainer className="mb-4">
          <Label htmlFor="number">Count of Ticket</Label>
          <Input id="ticket_count" placeholder="2" type="number" />
        </LabelInputContainer>
